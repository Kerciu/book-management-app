...
pub fn HomePage() -> impl IntoView {
    view! {
                <main>
                    ...
                    <div class="container">
                        <div class="welcome-info">"Zacznij korzystać z BookUp"</div>
                        <div class="welcome-info-bold">"BookUp to innowacyjna aplikacja do zarządzania kolekcją książek, która umożliwia dodawanie, ocenianie, recenzowanie i dzielenie się książkami z przyjaciółmi"</div>
                        <div class="welcome-info">"Dołącz już dziś!"</div>
                        <button class="button-start">"Dołącz teraz"</button>
                    </div>
                    ...
                    <div class="white-section">
                        ...
                        <div class="container">
                            <div>
                              ...
                              <div class="text-title">"Dodawanie Książek"</div>
                              <div class="information-body-text">"Dodawaj swoje ulubione książki do personalnej kolekcji w BookUp i miej do nich zawsze łatwy dostęp."</div>
                            </div>
                        </div>
